                          ...
                          child: Column(
                            children: [
                              RadioListTile(
                                ...
                                subtitle: const Text(
                                    "El alumno ha realizado sus tareas correctamente",
                                    style: TextStyle(color: Colors.black)),
                                value: YesNo.si,
                              ...
                              RadioListTile(
                                title: const Text("No",
                                    style: TextStyle(color: Colors.black)),
                                subtitle: const Text(
                                    "El alumno no ha realizado sus tareas",
                                    style: TextStyle(color: Colors.black)),
                                value: YesNo.no,
                                groupValue: haceTareas,
                                onChanged: (value) => setState(() {
                            ...
                            children: [
                              RadioListTile(
                                title: const Text("Sí",
                                    style: TextStyle(color: Colors.black)),
                                subtitle: const Text(
                                    "El alumno se ha portado correctamente",
                                    style: TextStyle(color: Colors.black)),
                                value: YesNo.si,
                              ...
                              RadioListTile(
                                title: const Text("No",
                                    style: TextStyle(color: Colors.black)),
                                subtitle: const Text(
                                    "El alumno no se ha portado correctamente",
                                    style: TextStyle(color: Colors.black)),
                                value: YesNo.no,
                                groupValue: buenComportamiento,
                                onChanged: (value) => setState(() {
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          left: 80, right: 80, top: 0, bottom: 40),
                      child: TextFormField(
                        decoration:
                            const InputDecoration(hintText: "Tu respuesta"),
